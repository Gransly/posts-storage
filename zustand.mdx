---js
{
    title: 'React Zustand state manager',
        coverUrl: 'https://raw.githubusercontent.com/pmndrs/zustand/main/bear.jpg',
    description: 'Zustand is cool and simgple',
    date: '13.03.2023',
    author: {
    name: 'Ishchenko F',
...
![Картиночка](https://www.mail-signatures.com/wp-content/uploads/2019/02/How-to-find-direct-link-to-image_Blog-Picture.png) <br>
Плюсы:
- просто
- flux
